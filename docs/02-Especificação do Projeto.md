...
|----------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
| Rafaela Miranda      | Ter um prazo de finalização do pedido.                                                                                                         | Para ter um controle do tempo de preparo e saber se está perto de ser finalizado.                                                               |
| Sebastião Silva      | Ter uma comunicação mais direta com o cliente.                                                                                                | Para obter ciência do comportamento do meu filho na escola e, assim, poder colaborar com seu aprendizado.                                       |
