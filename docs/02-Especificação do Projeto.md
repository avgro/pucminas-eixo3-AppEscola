...
| Flávia de Souza      | Avaliar a estrutura do estabelecimento, o atendimento, os pratos ou bebibas.                                                                  | Informar minha opinião sobre os pontos onde deve ser aperfeiçoado.                                                      |
