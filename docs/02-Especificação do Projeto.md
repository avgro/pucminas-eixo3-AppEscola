...
| Sebastião Silva      | De uma comunicação mais assertiva e direta com o cliente.                                                                                     | Fornecer um atendimento mais ágil e evitar erros de pedido.                                                                                     |
...
| Fernanda Teixeira    | Receber uma notificação quando for feito um pedido pelo cliente.                                                                              | Evitar falhas na comunicação e, assim, agilizar o pedido.                                                                                       |
